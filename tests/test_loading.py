...
from tests.test_models.models import TestModel


class LoadingTestCase(TestCase):
    """TestCase for loading classes."""

    @override_settings(MY_MODEL_SETTING='test_models.TestModel')
    ...
    @override_settings(MY_MODEL_SETTING='tests.test_models.models.TestModel')
